...
$el_item = GetSQLValueString( $_GET['la_pista'], "int");


/******************* SQL PARA DESPLEGAR LOS USUARIOS QUE ESTAN EN EL SISTEMA *************/
$query_DatosOficios = sprintf("SELECT * FROM tblpista  WHERE idPista= $el_item ORDER BY idPista DESC " );
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "nuevonivel")) {
    ...
    $updateSQL= sprintf("UPDATE tblpista SET  intEstado=%s WHERE idPista= $el_item",
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header"><span class="glyphicon glyphicon-save-file" aria-hidden="true"></span>
                  <h3 class="box-title">Modificar nivel</h3>
                </div><!-- /.box-header -->
                
 <div class="col-md-12">
                    <div class="box box-solid box-primary">
                      <div class="box-header">
                        <h3 class="box-title">Formulario para modificar nivel</h3>
                      </div><!-- /.box-header -->
                      <div class="box-body">
                   ...
                   <!-- ALERT PARA INDICAR QUE CAMPO NO DEBE ESTAR VACIO WCG -->
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                  <input type="text" class="form-control" id="strDescripcion" name=" strDescripcion" placeholder="Descripción" value="<?php echo $row_DatosOficios['strDescripcion']; ?>">
                                </div>
                                  </br>     </br>   
                              </div>                                                
...
function validaralta()
{
  ...
  //COLORES
  if (document.nuevonivel.strDescripcion.value == ""){
    $("#aviso1").show("slow");
      valid = false;
  }

  if (document.nuevaseccion.intEstado.value == ""){
    $("#aviso2").show("slow");
      valid = false;
  }
