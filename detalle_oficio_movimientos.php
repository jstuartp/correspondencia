    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Oficios de Entrada/ Revisión de Jefatura
            <small>| Oficina de Divulgación</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="bien.php"><i class="fa fa-dashboard"></i> Principal</a></li>
             <li><a href="listado_oficios_por_archivar.php"> Listado de oficios listos para Archivar</a></li>
            <li class="active">Detalle oficio por archivar</li>
          </ol>
        </section>
                 ...
                 <div class="col-md-8">
                  ...
                  <div class="box box-warning box-solid">
                    <div class="box-header with-border">
                      ...
                      <h3 class="box-title">Detalle del Oficio: </h3> 
                        <?php 
                    ...
                    <div class="box-body" style="display: block;">
                      ...
                      <?php echo "Asunto:  ".$row_DatosOficios['asunto'] ;?>
                    </div><!-- /.box-body --> 
        ...
        <ul class="dropdown-menu pull-right">
                            ...
                            <li>
                    <a class="" href="#"><i class="fa fa-cogs"></i> <span>General</span></a>                </li>
                            <li>
                    <a class="" href="#"><i class="fa fa-group"></i> <span>Miembros</span></a>                </li>
                            <li>
                    <a class="" href="#" data-method="POST"><i class="fa fa-times"></i> <span>Cancel Membership</span></a>                </li>
                            <li>
                    <a class="" href="#"><i class="fa fa-rocket"></i> <span>Módulos</span></a>                </li>
                            <li>
                    <a class="tt" href="#" title="" data-method="POST" data-toggle="tooltip" data-placement="left" data-original-title="This option will hide new content from this space at your dashboard"><i class="fa fa-eye-slash"></i> <span>Hide posts on dashboard</span></a>                </li>
         ...
         <td>
                      ...
                      <div class="direct-chat-text">
                        <?php 
                            ...
                            //echo respuestaUsuario($row_UsuariosAsignados['usuario_id'],($el_oficio));
                            ...
                            if ($la_respuesta ==""){
                                ...
                                echo "no hay respuesta del usuario aún ya que oficio fue asignado ó trasladado"; 
...
?>
       ...
       <!-- espacio eliminano ya que jefatura no puede eliminar usuarios si ya el oficio esta para ser archivado -->
      <!--  <td><a href="borrar_usuario_oficio.php?usuario_id=<?php //echo $row_UsuariosAsignados['usuario_id']."&el_id=".$row_UsuariosAsignados['id_oficioin']; ?>  "><div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-eraser"></i> Borrar</div></a>-->
       </td>
      </tr>
