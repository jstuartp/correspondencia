...
$query_DatosOficios = sprintf("SELECT * FROM info_oficios WHERE tipo_oficio=1 OR tipo_oficio=2 AND id_estado = 6 ORDER BY info_oficios.oficio_id DESC" );
...
<html>
  ...
  <body class="hold-transition skin-blue sidebar-mini">
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Lista de oficios ingresados al sistema</h3>
                </div><!-- /.box-header -->
    ...
    //AQUI ES DONDE SE SACAN LOS DATOS, SE COMPRUEBA QUE HAY RESULTADOS
              ...
              ?>
                      <tr>
                        <td><?php echo $row_DatosOficios["oficio_id"]; ?></td>
                        <td><?php echo $row_DatosOficios["asunto"];?></td>
                        <td><?php echo $row_DatosOficios["fecha"];?></td>
                        <td> <?php echo $row_DatosOficios["oficio_id"];?></td>
                        <td> <?php echo $row_DatosOficios["id_estado"];?></td>
