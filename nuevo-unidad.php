...
$DatosOficios = $_daoUnidad->GetUnidad();
$row_DatosOficios = $_daoUnidad->GetArrayData($DatosOficios);
$totalRows_DatosOficios = $_daoUnidad->TotalRows($DatosOficios);
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "nuevonivel")) {
 ...
 $_daoUnidad->SetUnidad($_POST['unidad']);   
...
<html>
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header"><span class="glyphicon glyphicon-save-file" aria-hidden="true"></span>
                  <h3 class="box-title">Insertar nueva Unidad</h3>
                </div><!-- /.box-header -->
                
              <div class="col-xl-12">
                    <div class="box box-solid box-primary">
                      <div class="box-header">
                        <h3 class="box-title">Formulario para insertar una nueva Unidad</h3>
                      </div><!-- /.box-header -->
                      <div class="box-body">
 ...
 <!-- ALERT PARA INDICAR QUE CAMPO NO DEBE ESTAR VACIO WCG -->
                              ...
                              <div class="form-group">
                                <label for="descripcion" class="col-sm-2 control-label">Nombre Unidad</label>
                                <div class="col-sm-10">
                                  <input type="text" class="form-control" id="unidad" name="unidad" placeholder="unidad">
                                </div>
                                  </br>     </br>   
                              </div>                                                
                                     <div class="alert alert-danger oculto " role="alert" id="aviso1"><span class="glyphicon glyphicon-remove" ></span>El nombre de la Unidad no debe estar vacio</div>                
                      ...
                      <table id="example2" class="table table-bordered table-hover"> 
                        ...
                        if ($totalRows_DatosOficios > 0) {  
                           do {  ?>
                                          ...
                                          <tr class="info"> 
                                          <th scope="row"><?php echo $row_DatosOficios["id_unidad"]; ?></th> 
                                          <td><?php echo $row_DatosOficios["nombre"]; ?></td>

                                      

                                          <td><a href="modificar-nivel.php?id_nivel=<?php echo $row_DatosOficios['id_unidad']; ?>"><div class="col-md-3 col-sm-4"><i class="glyphicon glyphicon-wrench"></i> </div></a></td>
