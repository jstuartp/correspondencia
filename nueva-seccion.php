...
$query_DatosOficios = sprintf("SELECT * FROM secciones ORDER BY id_seccion DESC " );
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "nuevaseccion")) {
  ...
  $insertSQL = sprintf("INSERT INTO secciones (descripcion, autorizado) VALUES (%s, %s)",
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header"><span class="glyphicon glyphicon-save-file" aria-hidden="true"></span>
                  <h3 class="box-title">Insertar nueva sección</h3>
                </div><!-- /.box-header -->
                
                <div class="col-xl-12">
                    <div class="box box-solid box-primary">
                      <div class="box-header">
                        <h3 class="box-title">Formulario para insertar nueva sección</h3>
                      </div><!-- /.box-header -->
                      <div class="box-body">
 ...
 <!-- ALERT PARA INDICAR QUE CAMPO NO DEBE ESTAR VACIO WCG -->
                ...
                <div class="box-body col-xl-12">
                  <div class="bs-example" data-example-id="contextual-table"> 
                    ...
                    <?php 
                        ...
                        if ($totalRows_DatosOficios > 0) {  
                           do {  ?>
                                          ...
                                          <th scope="row"><?php echo $row_DatosOficios["id_seccion"]; ?></th> 
                                        ...
                                        <!--  <td><a href="borrar_seccion.php?id_seccion=<?php echo $row_DatosOficios['id_seccion']; ?>"><div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-eraser"></i></div></a></td> -->

                                          <td><a href="modificar-seccion.php?id_seccion=<?php echo $row_DatosOficios['id_seccion']; ?>"><div class="col-md-3 col-sm-4"><i class="glyphicon glyphicon-wrench"></i> </div></a></td>
                   ...
                   Nota: Los Secciones que se autoricen tendrán los privilegios ver los movimientos que se generen en los usuarios
                </div><!-- /.box-body -->
