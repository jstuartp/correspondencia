...
//$query_DatosOficios = sprintf("SELECT * FROM info_oficios WHERE (tipo_oficio=1 OR tipo_oficio=2) AND ((id_estado = 8) or (id_estado = 9)) and oficio_id = $el_oficio ORDER BY info_oficios.oficio_id ASC" );

/* Consulta modificada por STUART */
$query_DatosOficios = sprintf("SELECT * FROM info_oficios WHERE (tipo_oficio=1 OR tipo_oficio=2) AND id_estado = 5 AND oficio_id = $el_oficio ORDER BY info_oficios.oficio_id ASC" );
...
<?php /*if ( $row_DatosOficios['id_estado'] == 6 ){  
