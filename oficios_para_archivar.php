...
$query_DatosOficios = sprintf("SELECT DISTINCT       
                          info_oficios.oficio_id, 
                          info_oficios.oficio_id2,
                          info_oficios.asunto, 
                          info_oficios.anno, 
                          info_oficios.usuario_inserta, 
                          info_oficios.fecha, 
                          
                          info_oficios.no_oficio,
                          info_oficios.imagen,
                          info_oficios.id_estado, 
                          oficios_usuario.id_oficioin, 
                          oficios_usuario.id_estado, 
                          oficios_usuario.observacion 
                            FROM info_oficios
                                INNER JOIN oficios_usuario on info_oficios.oficio_id = oficios_usuario.id_oficioin
                                  WHERE           oficios_usuario.id_estado = 5 and 
                                                   
                                            
                                                  info_oficios.anno = $el_anno " );
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Total Oficios para pasar a archivo
          ...
          <ol class="breadcrumb">
            <li><a href="bien.php"><i class="fa fa-dashboard"></i> Principal</a></li>
                        <li class="active">Oficios para pasar a archivo</li>
          </ol>
        </section>
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header"><span class="glyphicon glyphicon-align-justify" aria-hidden="true"></span>
                  <h3 class="box-title">Listado Total de oficios para pasar a archivo</h3>
                </div><!-- /.box-header -->
                      ...
                      <tr>
                        ...
                        <td> <?php echo $row_DatosOficios["anno"];?></td>
                         <td> 
                            ...
                            <a href="archivar_ok.php?oficio_id=<?php echo $row_DatosOficios['oficio_id']; ?>">Cambiar Estado</a>
