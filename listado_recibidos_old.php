<?php require_once('DAO_recibidos_old.php'); 
...
$_DAORecibidosOld = new DAO_recibidos_old();
...
<html>
  ...
  <body class="hold-transition skin-blue sidebar-mini">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Listado Oficios Años Anteriores</li>
          </ol>
        </section>
                ...
                <div class="box-body">
                    ...
                    <thead>
                      <tr>
                        ...
                        <th>PDF archivo</th>
                        <th hidden="true">Fecha recibido</th>                     
    ...
    //AQUI ES DONDE SE SACAN LOS DATOS, SE COMPRUEBA QUE HAY RESULTADOS
              ...
              ?>
                      <tr>
                        <td><?php echo $row_DatosOficios["Id_corre_reci"];  ?></td>
                        ...
                        <td><?php echo date('d-m-Y', strtotime($row_DatosOficios["fecha_reci"]));  ?></td>
                        <td> <?php echo $row_DatosOficios["destinatario"]; ?></td>
                        <td> <?php echo $row_DatosOficios["observaciones"]; ?></td>
                         <td>
                              
                            <a class="btn btn-block btn-primary view-pdf" href="<?php echo ("imagenes/recibidas_old/".date('Y', strtotime($row_DatosOficios["fecha_reci"]))."/".$row_DatosOficios["archivo_pdf"]); ?> " class="btn label-info detalles"> 
                                   
                                <span class="glyphicon glyphicon-comment"></span> Detalles
                            </a>
                          </td>   
                          <td hidden="true"><?php echo $row_DatosOficios["fecha_reci"];  ?></td>
...
table = $('#example2').DataTable({
   "paging": true,
          ...
          "info": true,
          "autoWidth": false,
          "order": [[ 9, "desc" ],[0,"desc"]] // orden de los resultados primero columna 0 los IN y luego por año columna 3
