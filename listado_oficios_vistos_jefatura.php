...
RestringirAcceso("0,2,3,4,5,6");?> <!-- accesso -->
<?php 


$query_DatosOficios = sprintf("SELECT * FROM info_oficios WHERE (tipo_oficio=1 OR tipo_oficio=2) AND  id_estado = 6 ORDER BY info_oficios.oficio_id ASC" );
...
<html>
  ...
  <body class="hold-transition skin-blue sidebar-mini">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Listado Oficios vistos Jefatura</li>
          </ol>
        </section>
        ...
        <section class="content">
          <div class="row">
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header"> <i class="fa fa-eye" aria-hidden="true"></i>
                  <h3 class="box-title">Listado de oficios vistos por Jefatura </h3>    
                </div><!-- /.box-header -->
    ...
    //AQUI ES DONDE SE SACAN LOS DATOS, SE COMPRUEBA QUE HAY RESULTADOS
              ...
              ?>
                      <tr>
                        <td><?php echo $row_DatosOficios["oficio_id2"]; ?></td>
                        ...
                        <td> 
                        <a href="detalle_oficio_visto.php?oficio_id=<?php echo $row_DatosOficios["oficio_id"];?>" class="btn btn-info" role="button">Ver PDF</a>
