...
if (  $la_seccion == $config['seccion_archivo']) {
                           ...
                           if  (( $row_DatosOficios['id_estado']== 0) or  ( $row_DatosOficios['id_estado']== 5) ) { ?>
                        <td> <a href="archiva_oficio_out.php?oficio_id=<?php echo $row_DatosOficios["oficio_id"];?>"<?php  ?> <i class="glyphicon glyphicon-log-in"></i></td>
                        <?php } else  if ( $row_DatosOficios['id_estado'] <> 0) { ?>  <td> </td> <?php } 
           ...
           <!-- LLAMARADO DEL MODAL PARA INSERTAR EL OFICIO SALIDA EN BD Y ARCHIVARLO -->
                ...
                <!-- FIN LLAMARADO DEL MODAL PARA INSERTAR EL OFICIO SALIDA EN BD Y ARCHIVARLO -->
