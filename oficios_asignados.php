...
$query_DatosOficios = sprintf(
    ...
    FROM 
      ...
      estado_oficio 
            ...
            ( oficios_usuario.id_estado=9 ) /* linea original ( oficios_usuario.id_estado=1 or  oficios_usuario.id_estado=8) modificada por STUART */
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Oficios Asignados</li>
          </ol>
        </section>
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  ...
                  <h3 class="box-title">Listado de oficios asignados</h3>
                </div><!-- /.box-header -->
