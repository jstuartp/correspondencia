...
$imprime_usuario=ObtenerNombreApellido($el_usuario);
...
$query_DatosOficios = sprintf(
    ...
    FROM 
      ...
      estado_oficio 
            ...
            usuario_id = $el_usuario and  estado_oficio.id_estado= oficios_usuario.id_estado and   
            ( oficios_usuario.id_estado=1 or oficios_usuario.id_estado= 8 ) 
            ORDER BY oficios_usuario.id_oficioin DESC,
            oficios_usuario.id_estado ASC");
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="reporte_actividades.php"><i class="fa fa-dashboard"></i> Reporte Actividades</a></li>
            <li class="active">Reporte de Oficios </li>
          </ol>
        </section>
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  ...
                  <h1><div class="alert alert-danger">
  Listado de oficios asignados sin cambios a la fecha por parte de: <?php echo $imprime_usuario; ?> 
</div> <h1>
                  <h1 class="box-title">Listado de oficios asignados sin cambios a la fecha por parte de: <?php echo $imprime_usuario; ?>  </h1>
                </div><!-- /.box-header -->
