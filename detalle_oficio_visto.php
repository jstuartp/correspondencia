...
$query_DatosOficios = sprintf("SELECT * FROM info_oficios WHERE (tipo_oficio=1 OR tipo_oficio=2) AND  id_estado = 6 and oficio_id = $el_oficio ORDER BY info_oficios.oficio_id ASC" );
...
$Result1 = mysqli_query($con, $updateSQL) or die(mysqli_error($con));
 ...
 $insertGoTo = "detalle_oficio_visto.php";
  if (isset($_SERVER['QUERY_STRING'])) {
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Detalle de Oficio Visto por Jefatura</li>
          </ol>
        </section>
 ...
 <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1" onSubmit="javascript:return validaralta();">
  ...
  <div class="form-group">
   ...
   <div class="alert alert-danger oculto" role="alert" id="aviso1"><span class="glyphicon glyphicon-remove" ></span> La observación no debe estar vacía</div>
                  ...
                  <input type="hidden" name="id_estado" value="9" />
...
<div class="bg-light-blue disabled color-palette"><span>|</span></div>
    ...
    <tbody>
      ...
      <tr>
       ...
       <td><?php  if ($row_UsuariosAsignados['id_estado'] == 1) 
                { 
                   ?>
