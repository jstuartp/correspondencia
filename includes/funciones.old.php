...
function cuentaOficiosAsignados2 ($id)
{
  ...
  $query_ConsultaFuncion = sprintf(" SELECT   COUNT(id_oficioin ) as suma
                                          FROM 
                                                  oficios_usuario
                                          WHERE 
                                                  ( ( oficios_usuario.id_estado= 1) or 
                                                  ( oficios_usuario.id_estado= 8 ) ) and 
                                                  oficios_usuario.usuario_id  =  ".GetSQLValueString($id, "int" )." ");
  //echo $query_ConsultaFuncion;
  $ConsultaFuncion = mysqli_query($con,  $query_ConsultaFuncion) or die(mysqli_error($con));
  $row_ConsultaFuncion = mysqli_fetch_assoc($ConsultaFuncion);
...
function cuentaOficiosTramite ($id)
{
  ...
  $query_ConsultaFuncion = sprintf(" SELECT   COUNT(id_oficioin ) as suma
                                          FROM 
                                                  oficios_usuario
                                          WHERE 
                                                  oficios_usuario.id_estado= 2 and 
                                                  oficios_usuario.usuario_id  =  ".GetSQLValueString($id, "int" )." ");
  //echo $query_ConsultaFuncion;
  $ConsultaFuncion = mysqli_query($con,  $query_ConsultaFuncion) or die(mysqli_error($con));
  $row_ConsultaFuncion = mysqli_fetch_assoc($ConsultaFuncion);
...
function cuentaOficiosTramitados ($id)
{
  ...
  $query_ConsultaFuncion = sprintf(" SELECT   COUNT(id_oficioin ) as suma
                                          FROM 
                                                  oficios_usuario
                                          WHERE 
                                                  oficios_usuario.id_estado= 3 and 
                                                  oficios_usuario.usuario_id  =  ".GetSQLValueString($id, "int" )." ");
  //echo $query_ConsultaFuncion;
  $ConsultaFuncion = mysqli_query($con,  $query_ConsultaFuncion) or die(mysqli_error($con));
  $row_ConsultaFuncion = mysqli_fetch_assoc($ConsultaFuncion);
...
function cuentaOficiosNuevosEntrada ($id)
{
  ...
  $query_ConsultaFuncion = sprintf("SELECT COUNT(oficio_id1 ) as suma
                                FROM info_oficios
                                WHERE info_oficios.id_estado=7 and info_oficios.oficio_id 
                                NOT IN
...
function  ObtenerOficioId ($id)
{
  ...
  mysqli_free_result($ConsultaFuncion);
  return $row_ConsultaFuncion['dependencia']. "".$row_ConsultaFuncion['oficio_id1']. "-". $row_ConsultaFuncion['anno'];
...
function ObtenerTotalGrafico ($identificador)
{
  ...
  $query_ConsultaFuncion = sprintf("
    ...
    SELECT SUM(id_estado=1) as ASIGNADOS, SUM(id_estado=2) as EN_TRAMITE, SUM(id_estado=3) as TRAMITADOS, SUM(id_estado=8) as TRASLADADOS
FROM 
oficios_usuario WHERE fecha_asignado >='$identificador' ",GetSQLValueString($identificador, "date"));
  ...
  return $row_ConsultaFuncion['ASIGNADOS'].",".$row_ConsultaFuncion['EN_TRAMITE'].",".$row_ConsultaFuncion['TRAMITADOS'].",".$row_ConsultaFuncion['TRASLADADOS'] ;
  ;
}
